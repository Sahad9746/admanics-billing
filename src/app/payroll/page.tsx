      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-neutral-900 border border-neutral-800 p-6 rounded-xl">
            <h3 className="text-sm font-medium text-neutral-400">Total Monthly Base Salary</h3>
            <p className="text-3xl font-bold text-white mt-2">₹{totalBaseSalary.toLocaleString()}</p>
          </div>
          <div className="bg-neutral-900 border border-neutral-800 p-6 rounded-xl">
            <h3 className="text-sm font-medium text-neutral-400">Active Employees</h3>
            <p className="text-3xl font-bold text-white mt-2">{employees.length}</p>
          </div>
          <div className="bg-neutral-900 border border-neutral-800 p-6 rounded-xl">
            <h3 className="text-sm font-medium text-neutral-400">Total Pending Advances</h3>
                ...
                {employees.map((emp: any) => {
                  ...
                  return (
                    <tr key={emp._id} className="hover:bg-neutral-800/50 transition-colors">
                      ...
                      <td className="px-6 py-4 font-bold text-white">₹{emp.baseSalary?.toLocaleString() || 0}</td>
